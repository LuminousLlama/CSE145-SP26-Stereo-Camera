...
IMV_API int IMV_CALL
IMV_GIGE_ForceIpAddress(IN IMV_HANDLE handle, IN const char *pIpAddress, IN const char *pSubnetMask, IN
                        const char *pGateway);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_GIGE_GetAccessPermission(IN IMV_HANDLE handle, OUT IMV_ECameraAccessPermission *pAccessPermission);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_LoadDeviceCfg(IN IMV_HANDLE handle, IN const char *pFullFileName, OUT IMV_ErrorList *pErrorList);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_StartGrabbingEx(IN IMV_HANDLE handle, IN uint64_t maxImagesGrabbed, IN IMV_EGrabStrategy strategy);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL IMV_GetChunkDataByIndex(IN IMV_HANDLE handle, IN IMV_Frame *pFrame, IN unsigned int index, OUT
                                             IMV_ChunkDataInfo *pChunkDataInfo);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_GetDoubleFeatureValue(IN IMV_HANDLE handle, IN const char *pFeatureName, OUT double *pDoubleValue);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_GetDoubleFeatureMin(IN IMV_HANDLE handle, IN const char *pFeatureName, OUT double *pDoubleValue);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_GetDoubleFeatureMax(IN IMV_HANDLE handle, IN const char *pFeatureName, OUT double *pDoubleValue);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_SetDoubleFeatureValue(IN IMV_HANDLE handle, IN const char *pFeatureName, IN double doubleValue);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_GetEnumFeatureValue(IN IMV_HANDLE handle, IN const char *pFeatureName, OUT uint64_t *pEnumValue);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_GetEnumFeatureSymbol(IN IMV_HANDLE handle, IN const char *pFeatureName, OUT IMV_String *pEnumSymbol);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_SetEnumFeatureSymbol(IN IMV_HANDLE handle, IN const char *pFeatureName, IN const char *pEnumSymbol);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_GetEnumFeatureEntryNum(IN IMV_HANDLE handle, IN const char *pFeatureName, OUT unsigned int *pEntryNum);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_GetEnumFeatureEntrys(IN IMV_HANDLE handle, IN const char *pFeatureName, IN_OUT IMV_EnumEntryList *pEnumEntryList);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_GetStringFeatureValue(IN IMV_HANDLE handle, IN const char *pFeatureName, OUT IMV_String *pStringValue);
...
/// \return Success, return IMV_OK. Failure, return error code 
IMV_API int IMV_CALL
IMV_SetStringFeatureValue(IN IMV_HANDLE handle, IN const char *pFeatureName, IN const char *pStringValue);
